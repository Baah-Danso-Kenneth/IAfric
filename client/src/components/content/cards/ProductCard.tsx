...
function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Link href={`/shop/${product.id}`} className="block">
      <div className="border border-gray-200 rounded-xl overflow-hidden bg-white shadow-sm hover:shadow-md transition-shadow duration-300 cursor-pointer">
        {/* Product Images */}
        ...
        {/* Product Info */}
        <div className="p-3">
          <h2 className="text-sm font-semibold text-gray-900 mb-1 hover:text-blue-600 transition-colors line-clamp-1">
            {product.name}
          </h2>
